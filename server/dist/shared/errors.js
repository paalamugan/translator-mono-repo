...
exports.TranslatorError = exports.UserNotFoundError = exports.ParamMissingError = exports.CustomError = void 0;
const http_status_codes_1 = __importDefault(require("http-status-codes"));
class CustomError extends Error {
    constructor(msg, httpStatus) {
        super(msg);
        this.HttpStatus = http_status_codes_1.default.BAD_REQUEST;
        this.HttpStatus = httpStatus || http_status_codes_1.default.BAD_REQUEST;
    }
}
...
class TranslatorError extends CustomError {
    constructor(message) {
        super(message || TranslatorError.Msg, TranslatorError.HttpStatus);
    }
}
exports.TranslatorError = TranslatorError;
TranslatorError.Msg = 'Some error occured. please try again later.';
TranslatorError.HttpStatus = http_status_codes_1.default.BAD_REQUEST;
